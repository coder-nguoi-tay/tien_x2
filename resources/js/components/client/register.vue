<template>
  <div class="container-fluid" style="background: #f2f6fd">
    <br />
    <div class="form-employer-register">
                    ...
                    <div class="modal-body">
                      <div class="register-policy">
                        ...
                        <div class="d-flex">
                          <div class="contact-1">
                            <button
                              class="btn rounded-circle transparent-1 py-1 px-2 btn-primary mr-2"
                            >
                          ...
                          <div>
                            <button
                              class="btn rounded-circle transparent-1 py-1 px-2 btn-primary mr-2 od-2"
                            >
                              <i class="fas fa-phone-alt"></i>
                            </button>
                ...
                >
                  ...
                  <div class="form-group row">
                    ...
                    <div class="form-group form-check">
                      <div
                        class="custom-control custom-checkbox form-check-input my-0"
                        type="checkbox"
                      >
                        <input
                          id="522sBGUn"
