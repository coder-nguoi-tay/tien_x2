<template>
    <div class="form-upload-check-cv">
        <div class="text-right mt-2 custom-check-cv d-flex">
            ...
            btn-custom-cv
            mr-2
          " :class="{ active: active == 1 }" @click="activeUpCv(1)">
                Dùng Cv đã tải lên
            </button>
            <button type="button" class="
            btn
            ...
            btn-custom-cv
            mr-2
          " :class="{ active: active == 2 }" @click="activeUpCv(2)">
                        ...
                        <div id="frm-select-cv-online">
                            <div class="p-3 rounded mx-auto d-block">
                                <div class="col-xs-6">
                                        ...
                                        <div class="p-2 custom-input">
                                            ...
                                            <div class="col-xs-12">
                                                <div class="form-group align-center">
                                                    <input type="checkbox" name="save_cv" class="checkbok" id="save_cv" />
                                                    <span htmlFor="save_cv">Lưu CV (Dùng để quản lý trong
                                                        <a target="_blank" class="text-highlight" href="">Hồ Sơ CV</a>
                                    ...
                                    <!-- end -->
                                    <div v-if="active == 1">
                                        <label><span class="custom-text">Chọn Cv Đã Tải Lên</span>:
                                            <span class="italic text-primary text-small">
                                                Khuyên Dùng</span></label>
                                        ...
                                        <br />
                                        <span v-if="cv.length == 0" class="text-danger">Bạn chưa có cv nào, hãy bắt đầu
                                            <a href="#">Tạo mới Cv</a> hoặc tải cv từ máy tính
                                            cá nhân
                                        </span>
                                    </div>
                                        ...
                                        <ul class="cv-choosen justify-content-center border p-4">
                                            <li class="w-100">
                                                <div class="text-left">
                                                    ...
                                                    <p>
                                                        <span class="text-danger">2.</span> Để có trải
                                                        nghiệm tốt nhất, bạn nên sử dụng các trình duyệt phổ
                                                        biến như Google Chrome hoặc Firefox.
                                                    </p>
                                                    <p class="text-red">
                                                        <span class="text-danger">3.</span>
                                                        Trước tình trạng gia tăng các hình thức lừa đảo việc
                                                        làm trên internet được các cơ quan chức năng cảnh
                                                        báo, TopCV xin lưu ý bạn một số dấu hiệu lừa đảo
                                                        việc làm như sau:
                                                    </p>
                                                </div>
                                            </li>
