                  ...
                  <div class="contact-form-action">
                    <div class="MultiFile-intercepted">
                      <div class="row">
                        ...
                        <div class="col-lg-4 column-lg-full">
                          <div class="input-box">
                            ...
                            <div class="form-group">
                              ...
                              <Field name="quatity" type="number" min="1" v-model="model.quatity" rules="required"
                        ...
                        <div class="col-lg-4 column-lg-full">
                          <div class="input-box">
                            ...
                            <div class="form-group user-chosen-select-container">
                              <Field name="sex" as="select" v-model="model.sex" rules="required" class="form-control">
                        ...
                        <div class="col-lg-4 column-lg-full">
                          <div class="input-box mt-4">
                            <label class="label-text">Chọn địa chỉ cụ thể</label>
                            <div class="form-group user-chosen-select-container">
                              <Field name="address" v-model="model.address" rules="required" class="form-control"
                                placeholder="địa chỉ" />
                            ...
                            <div class="row">
                              <div class="col-lg-12">
                                <div class="form-group">
                                  ...
                                  <picker-new-employer name="end_job_time" v-model="model.end_job_time"
                                    class="date-time"></picker-new-employer>
                        ...
                        <div class="col-lg-4 column-lg-full">
                          <div class="input-box mt-4">
                            ...
                            <div class="form-group user-chosen-select-container">
                              <Field name="profession_id" as="select" v-model="model.profession_id" rules="required"
                                class="form-control">
                                <option value disabled selected>
                                  Chọn vị trí
                                </option>
                        ...
                        <div class="col-lg-4 column-lg-full">
                          <div class="input-box mt-4">
                            <label class="label-text d-flex align-items-center">chọn trình độ
                              <i class="la la-question tip ml-1" data-toggle="tooltip" data-placement="top" title=""
                        ...
                        <div class="col-lg-4 column-lg-full">
                          <div class="input-box mt-4">
                            ...
                            <div class="form-group user-chosen-select-container">
                              <Field name="experience_id" as="select" v-model="model.experience_id" rules="required"
                                class="form-control">
                                <option value disabled selected>
                                  Chọn Kinh nghiệm
                                </option>
                        ...
                        <div class="col-lg-4 column-lg-full">
                          <div class="input-box mt-4">
                            ...
                            <div class="form-group">
                              <Editor name="describe" class="ckedit" v-model="model.describe" />
                            </div>
                          </div>
                        </div>
                        <div class="col-lg-4 column-lg-full">
                          <div class="input-box mt-4">
                            ...
                            <div class="form-group">
                              <Editor name="candidate_requirements" v-model="model.candidate_requirements" />
                            </div>
                          </div>
                        </div>
                        <!-- end col-lg-4 -->
                        <div class="col-lg-4 column-lg-full">
                          <div class="input-box mt-4">
                            <label class="label-text">Quyền lơi công việc</label>
                            <div class="form-group">
                          ...
                          <div class="input-box mt-4">
                            ...
                            <div class="form-group user-chosen-select-container">
                              <Field class="form-control" v-model="value" name="skill_id" rules="required">
                                <Multiselect placeholder="Chọn Kỹ năng" mode="tags" v-model="value" :searchable="true"
                                  :options="options" label="label" track-by="label" :infinite="true" :object="true"
                                  :filterResults="true" :clearOnSearch="true" :clearOnSelect="true"
                        ...
                        <div class="col-lg-4 column-lg-full">
                          <div class="input-box mt-4">
                            ...
                            <div class="form-group user-chosen-select-container">
                              <Toggle name="status_profile" v-model="model.status_profile" class="toggle-flag" on-label=""
                                off-label="" id="status_profile" />
                            </div>
                          </div>
                        </div>
                        <!-- end col-lg-12 -->
